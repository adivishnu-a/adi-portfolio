...
const About = () => {
  ...
  const imageKitUrl = "https://ik.imagekit.io/cowboypanda";
          ...
          <div className="w-full lg:w-3/5">
            <div className="animate-on-scroll from-left">
              ...
              <p className="text-muted-foreground mb-4">
                Final-year Computer Science student at SRM University, AP, with a passion for building innovative software solutions. Currently juggling my studies with a Product Development Internship at Darwinbox, where I'm gaining valuable industry experience.
              </p>
