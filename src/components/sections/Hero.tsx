    ...
    >
      ...
      <div className="text-center z-10 max-w-4xl mx-auto">
        <div className="mb-3 inline-block animate-fade-in">
          <img 
            src="https://ik.imagekit.io/cowboypanda/morty-modified.png?updatedAt=1741952501043"
            alt="Avatar"
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 animate-fade-in flex items-center justify-center gap-4">
          Hi, I'm{" "}
